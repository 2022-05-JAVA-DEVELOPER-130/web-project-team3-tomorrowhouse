...
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '3층선반'||product_p_no_seq.currval, 500000, 'shelf8.jpg', '3층선반입니다', 0, 1);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '3층선반'||product_p_no_seq.currval, 200000, 'shelf9.jpg', '3층선반입니다', 0, 1);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '3층선반'||product_p_no_seq.currval, 150000, 'shelf10.jpg', '3층선반입니다', 0, 1);
...
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '에어컨'||product_p_no_seq.currval, 250000, 'homeappliances1.jpg', '라디오입니다', 0, 3);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '에어컨2'||product_p_no_seq.currval,340000, 'homeappliances2.jpg', '스피커입니다', 0, 3);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '모니터'||product_p_no_seq.currval, 430000, 'homeappliances3.jpg', '멀티탭입니다', 0, 3);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '모니터2'||product_p_no_seq.currval,350000, 'homeappliances4.jpg', '전자레인지입니다', 0, 3);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '밥솥'||product_p_no_seq.currval, 550000, 'homeappliances7.jpg', '전자레인지입니다', 0, 3);
...
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '청소기'||product_p_no_seq.currval, 550000, 'homeappliances9.jpg', '전자레인지입니다', 0, 3);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '밝은조명'||product_p_no_seq.currval, 520000, 'light1.jpg', '조명1입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '스탠드조명'||product_p_no_seq.currval,210000, 'light2.jpg','조명2입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '조명전구'||product_p_no_seq.currval, 270000, 'light3.jpg', '조명3입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '조명전구'||product_p_no_seq.currval, 570000, 'light4.jpg', '조명4입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '조명전구'||product_p_no_seq.currval, 370000, 'light5.jpg', '조명5입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '조명전구'||product_p_no_seq.currval, 150000, 'light6.jpg', '조명6입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '조명전구'||product_p_no_seq.currval, 120000, 'light7.jpg', '조명7입니다', 0, 4);
insert into product(p_no, p_name, p_price, p_image, p_desc, p_click_count, cg_no) values(product_p_no_seq.nextval, '양은냄비'||product_p_no_seq.currval, 1000, 'pot1.jpg', '냄비1입니다', 0, 5);
