...
ALTER TABLE cart ADD CONSTRAINT IDX_cart_FK0 FOREIGN KEY (u_id) REFERENCES userinfo (u_id) ON DELETE SET NULL;
...
--ALTER TABLE orderitem drop CONSTRAINT IDX_orderitem_FK1;
...
ALTER TABLE review ADD CONSTRAINT IDX_review_FK1 FOREIGN KEY (oi_no) REFERENCES orderitem (oi_no)ON DELETE SET NULL;
