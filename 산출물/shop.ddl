...
CREATE TRIGGER orderitem_oi_no_TRG
BEFORE INSERT ON orderitem
FOR EACH ROW
BEGIN
IF :NEW.oi_no IS NOT NULL THEN
  SELECT orderitem_oi_no_SEQ.NEXTVAL INTO :NEW.oi_no FROM DUAL;
END IF;
END;
...
ALTER TABLE orderitem ADD CONSTRAINT IDX_orderitem_FK1 FOREIGN KEY (o_no) REFERENCES orders (o_no);
...
ALTER TABLE review ADD CONSTRAINT IDX_review_FK1 FOREIGN KEY (oi_no) REFERENCES orderitem (oi_no);
