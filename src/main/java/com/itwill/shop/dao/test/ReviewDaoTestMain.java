...
public class ReviewDaoTestMain {
	public static void main(String[] args) throws Exception {
		...
		reviewList=
		reviewDao.selectAllByUserId(new Review(0, null, null, "test6", null));
		...
		findReview =
		reviewDao.selectByOrderitemNo(new Review(0, null, null, null, new OrderItem(22, 0, 0, null)));
		...
		findReview=new Review(0, null, null, null, new OrderItem(0, 0, 0,product));
		reviewList=
		...
		findReview=new Review(11, null, null, null, null);
		findReview=
		...
		findReview=new Review(0, "리뷰_daoTestMain", "리뷰_daoTestMain 진행중", "test6", 
