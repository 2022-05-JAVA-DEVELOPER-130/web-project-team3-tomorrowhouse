...
공지사항 <input type ='text'name='n_title' value='<%=noticeDetail.getN_title()%>'><br>
공지사항 내용 <input type ='text'name='n_content' value='<%=noticeDetail.getN_content()%>'><br>
공지일 <input type ='text'name='n_date' value='<%=noticeDetail.getN_date()%>'><br>
